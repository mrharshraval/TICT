...
export const TAROT_CARDS: TarotBaseCard[] = [
  ...
  { id: '2', name: 'The High Priestess', type: 'major', image: '/tarot-cards/major/woman-pillars-scroll-moon.jpg' },
  ...
  { id: '5', name: 'The Hierophant', type: 'major', image: '/tarot-cards/major/spiritual-teacher-throne-keys.jpg' },
  ...
  { id: '10', name: 'Wheel of Fortune', type: 'major', image: '/tarot-cards/major/wheel-sphinx-snake-anubis.jpg' },
  { id: '11', name: 'Justice', type: 'major', image: '/tarot-cards/major/figure-scales-sword-purple-veil.jpg' },
  { id: '12', name: 'The Hanged Man', type: 'major', image: '/tarot-cards/major/man-upside-down-tree-halo.jpg' },
  { id: '13', name: 'Death', type: 'major', image: '/tarot-cards/major/skeleton-knight-white-horse.jpg' },
  ...
  { id: '17', name: 'The Star', type: 'major', image: '/tarot-cards/major/woman-pouring-water-stars-pool.jpg' },
  ...
  { id: 'w6', name: 'Six of Wands', type: 'minor', suit: 'wands', image: '/tarot-cards/minor/wands/rider-horse-laurel-wreath-wands.jpg' },
  ...
  { id: 'w10', name: 'Ten of Wands', type: 'minor', suit: 'wands', image: '/tarot-cards/minor/wands/figure-carrying-heavy-wands-town.jpg' },
  { id: 'w11', name: 'Page of Wands', type: 'minor', suit: 'wands', image: '/tarot-cards/minor/wands/messenger-tall-wand-desert.jpg' },
  { id: 'w12', name: 'Knight of Wands', type: 'minor', suit: 'wands', image: '/tarot-cards/minor/wands/knight-rearing-horse-wand-desert.jpg' },
  { id: 'w13', name: 'Queen of Wands', type: 'minor', suit: 'wands', image: '/tarot-cards/minor/wands/queen-throne-sunflower-black-cat.jpg' },
  ...
  { id: 'c3', name: 'Three of Cups', type: 'minor', suit: 'cups', image: '/tarot-cards/minor/cups/three-women-raising-cups-celebration.jpg' },
  ...
  { id: 'c13', name: 'Queen of Cups', type: 'minor', suit: 'cups', image: '/tarot-cards/minor/cups/queen-throne-water-ornate-cup.jpg' },
  ...
  { id: 'p3', name: 'Three of Pentacles', type: 'minor', suit: 'pentacles', image: '/tarot-cards/minor/pentacles/craftsman-cathedral-three-pentacles.jpg' },
  ...
  { id: 'p9', name: 'Nine of Pentacles', type: 'minor', suit: 'pentacles', image: '/tarot-cards/minor/pentacles/woman-vineyard-falcon-nine-pentacles.jpg' },
  ...
  { id: 'p14', name: 'King of Pentacles', type: 'minor', suit: 'pentacles', image: '/tarot-cards/minor/pentacles/king-throne-pentacle-scepter-bull.jpg' },
];
